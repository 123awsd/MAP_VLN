...
DEFAULT_LOG_DIR = "/home/nv/localization_only_ws/logs/circle_tracking"
...
def latest_log_path(log_dir):
    pattern = os.path.join(log_dir, "circle_tracking_*.csv")
...
def main():
    parser = argparse.ArgumentParser(description="Analyze circle trajectory tracking CSV.")
