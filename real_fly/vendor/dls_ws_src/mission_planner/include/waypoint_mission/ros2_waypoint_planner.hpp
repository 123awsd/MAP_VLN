        ...
        void GoalPubTimerCallback() {
            ...
            if (new_goal || cur_t - last_pub_time > cfg_.publish_dt) {
                ...
                goal_log << std::fixed << std::setprecision(2)
                         << " -- [MISSION] Publish waypoint " << waypoint_counter + 1 << "/"
                         << cfg_.waypoints.size() << ": position=["
                         << cfg_.waypoints[waypoint_counter].x() << " "
                         << cfg_.waypoints[waypoint_counter].y() << " "
                         << cfg_.waypoints[waypoint_counter].z() << "], distance="
                         << (cfg_.waypoints[waypoint_counter] - cur_position).norm() << " m.";
