...
namespace path_search {
    ...
    class Astar {
        ...
        std::function<bool(const rog_map::Vec3f &, const rog_map::Vec3f &)>
            transition_validator_;
    ...
    public:
        ...
        void setTransitionValidator(
            std::function<bool(const rog_map::Vec3f &, const rog_map::Vec3f &)> validator) {
            transition_validator_ = std::move(validator);
        }
