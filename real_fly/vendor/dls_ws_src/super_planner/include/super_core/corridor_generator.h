...
#define DEBUG_FILE_DIR(name) (string(string(ROOT_DIR) + "log/"+name))
    ...
    private:
        ...
        vec_Vec3f latest_pc;
        vec_Vec3f static_obstacle_cloud_;
        bool use_static_obstacle_cloud_{false};

        void collectObstacleCloud(const Vec3f &box_min, const Vec3f &box_max,
    ...
    public:
        ...
        // Optional exact obstacle geometry for offline/global planning.  When
        // set, CIRI constructs its separating planes from these points instead
        // of quantized occupancy-voxel centers.
        void SetStaticObstacleCloud(const vec_Vec3f &obstacle_cloud);
