...
download_boxer=false
if [[ "${1:-}" == "--download-boxer-weights" ]]; then
  download_boxer=true
elif [[ $# -gt 0 ]]; then
...
echo "Bootstrap complete. Run ./scripts/check_setup.sh and then the README smoke test."
